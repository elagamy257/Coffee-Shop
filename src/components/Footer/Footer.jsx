                ...
                <div className="container grid md:grid-cols-3 pb-20 pt-5">
                    ...
                    <div className="py-8 px-4">
                        ...
                        <p className="  pt-4"> 
                            ...
                            Espresso Escape </p>
                        <a href="https://github.com/elagamy257" target="_blank"className="inline-block bg-[#3d2517] py-2 px-4 mt-5 text-sm rounded-full">
                        My Github Account
                        </a>
                    </div>
                    ...
                    <div className="col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10">
                        ...
                        <div className="py-8 px-4 col-span-2 sm:col-auto">
                            ...
                            <div>
                                <p className="mb-3">Cairo ,Egypt</p>
                                <p>+20 1093911076</p>

                                {/* social links */}
                                <div className="flex items-center gap-3 mt-6">
                                <a href="https://www.instagram.com/elagamy725?igsh=MTNvamNodGNhdDFuYQ==" target="_blank">
                                    <FaInstagram className="text-3xl hover:text-primary duration-300" />
                                </a>
                                <a href="https://www.facebook.com/share/18EFuiM4JN/" target="_blank">
                                    <FaFacebook className="text-3xl hover:text-primary duration-200" />
                                </a>
                                <a href="https://www.linkedin.com/in/aya-elagamy257" target="_blank">
